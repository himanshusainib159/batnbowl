package com.batnbowl.apis.services.impl;

import com.batnbowl.apis.entities.Match;
import com.batnbowl.apis.repositories.MatchRepo;
...
//        Optional<Match> existingMatch = matchRepo.findByTeamHeading(match1.getTeamHeading());
//
//        if (existingMatch.isPresent()) {
//            // If a match with the same team heading exists, update it
//            Match matchToUpdate = existingMatch.get();
//            matchToUpdate.setMatchId(match1.getMatchId());
//            this.matchRepo.save(matchToUpdate);
//        } else {
//            // If no match with the same team heading exists, save the new match
//            this.matchRepo.save(match1);
//        }
